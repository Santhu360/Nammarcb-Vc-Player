...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/8caa5caad1e3f561633e3-6302d83cd06064dd43.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    text="Join Channel", url=f"https://t.me/superior_bots"
                )
            ]
        ]
    )
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"Playing {sname} Via Zaidsaavn in linked channel",
    )
    os.remove("final.png")
